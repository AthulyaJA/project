...
<body>
    <h1><i>Student Detiles view</i><h1>
        <a href="<?php echo base_url()?>Athu/wow1">Back to profile</a>
        <form method="POST" action="<?php echo base_url()?>Athu/approvedetails">
<?php
if(isset($user_data))
{
     ...
     <td><?php echo $row->first_name;?></td>
        ...
        <td><?php echo $row->education; ?></td>
         ...
         if($row->status==1)
         {
             ?>
             <td>Approved</td>
             <td><a href="<?php echo base_url()?>Athu/reject/<?php echo $row->loginid;?> ">Reject</a></td>
             <?php
             }
             elseif($row->status==2)
             {
                 ?>
                 <td>Rejected</td>
                 <td><a href="<?php echo base_url()?>Athu/approve/<?php echo $row->loginid;?>">Approve</a></td>
                 <?php
             }
             else{
                 ?>
