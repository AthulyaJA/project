...
<nav class="menubar">
    		<ul>
            		...
            		<li><a href="<?php echo base_url()?>Athu/approved">Detiles View</a>
            		<li><a href="<?php echo base_url()?>Athu/not">Add Notification</a></li>
            		<li><a href="<?php echo base_url()?>Athu/view_notificatio">view Notification</a></li>
